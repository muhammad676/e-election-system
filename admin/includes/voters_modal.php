...
<div class="modal fade" id="addnew">
    ...
    type = "number" maxlength="13" class="form-control" id="nic_no" name="nic_no" required>
                ...
                <div class="form-group">
                    <label for="constituency_name" class="col-sm-3 control-label">Constituency Name</label>
                ...
                <div class="form-group">
                    <label for="province_name" class="col-sm-3 control-label">Province Name</label>
...
<div class="modal fade" id="edit">
    ...
    type = "number" maxlength="13" class="form-control" id="edit_nic_no" name="nic_no" required>
                ...
                <div class="form-group">
                    <label for="edit_constituency_name" class="col-sm-3 control-label">Constituency Name</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_constituency_name" name="constituency_name" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="edit_province_name" class="col-sm-3 control-label">Province Name</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_province_name" name="province_name" required>
                    </div>
                </div>
                <div class="form-group">
