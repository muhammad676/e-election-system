          ...
          <div class="box">
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, candidate_list.id AS canid FROM candidate_list  LEFT JOIN positions ON positions.id=candidate_list.position_id WHERE candidate_list.province = 'Punjab'";
